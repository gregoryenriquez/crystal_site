...
================================================== -->
  <body>
    ...
    <div id="centeredTextBody" style="margin-bottom: 50px;">
      ...
      <h1 id="tabTitle" style="margin-top: 0;">FAQ</h1>
      ...
      <p id="answer">
        Yes, I am available to travel to the client’s location whether it’s their home, venue, or hotel. The first 20 miles from Mountain View is complimentary. I am also always available for destination weddings Additional fees will apply for destination weddings. 
      </p>
    </br>
      <h4 id="question">
        Do you do hair? 
      ...
      <p id="answer">
        Makeup is my main focus and expertise, but I do offer stylish fuss-free chic &amp; timeless hairstyles-- loose waves &amp; curls, chignons, soft &amp; romantic undo’s, and any idea you have in mind!
      </p>
    </br>
      <h4 id="question">
        Do I have to schedule a makeup trial before my wedding day?
      </h4>
      <p id="answer">
        A bridal preview is entirely optional. I do recommend that you come in for a trial to preview your makeup look. If you don’t have time or don’t want to, that’s not a problem!  
      </p>
