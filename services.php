...
================================================== -->
  <body>
    ...
    <div id="centeredTextBody" style="margin-bottom: 50px;">
      <h1 id="tabTitle" style="margin-top: 0; margin-bottom: 0">Services</h1>
    </br>
      <p id="subTabBody" style="width: 70%; text-align: left; margin-left: auto; margin-right: auto">
        Mai Artistry provides the quintessential style of makeup artistry that makes you look and feel flawless on your wedding day! I aim to ensure that your styling desires are addressed and your vision is achieved. I will make sure that every detail of your makeup is taken care of, so that you won’t need to worry about it! 
</br></br> 
Our communication will be prompt from the initial e-mail to the your wedding day! On your special day, I will arrive on time with my makeup kit, lighting, and director’s chair to bring you the experience you’ve dreamed of in the comfort of your home or hotel suite! 
</br></br>
Together we will achieve your vision of the perfect look! 

      </p>
      <div id="centeredTextBody" style="width: 400px; padding-top: 10px">

          <h3 id="quicksand" style="margin-bottom: 0px">
            MAKEUP SERVICES
          </h3> 
          </br>
          <h4 id="quicksand" style="color: #333; margin-top: 0px">
            All services include lashes: 
          </h4>
        
        <ul style="list-style-type:none; text-align: left;">
          <li id="services-item">♥ Weddings (Bride, Maids &amp; Mothers)</li>
          <li id="services-item">♥ Boudoir </li>
          <li id="services-item">♥ Engagement </li>
          <li id="services-item">♥ Maternity </li>
          <li id="services-item">♥ Editorial + Photo Shoots </li>
          <li id="services-item">♥ Special Events</li>
          <li id="services-item">♥ Business Professional (real estate, sales)</li>
          <li id="services-item">♥ Prom/Teen Event</li>
          <li id="services-item">♥ Senior Pictures </li>
        </ul>
      </div>
    </div> 
