...
================================================== -->
  <body>
    ...
    <div id="centeredTextBody" style="margin-bottom: 50px">
      ...
      <p id="quicksand" style="width: 50%; text-align: left; margin-left: auto; margin-right: auto">
        For the last 10 years, I’ve been doing make up for my family and friends for all occasions ranging from a night out in town to a wedding event—it was my creative outlet. I love being able to enhance and accentuate the features on naturally beautiful faces. So, after many years of giving makeovers and make-up advice, I am finally pursuing my journey as a make-up artist. 
        </br></br>
        As a make-up artist, I strive to educate myself on the latest products, techniques, and ingredients so that I continue to produce the best results for my clients. 
        </br></br>
        Listening to my clients needs is very important, but producing their vision is my expertise!
      </br></br>
      -Crystal        
      </p>
    </div>
