        ...
        <nav class="navbar">
          <div class="container">
              <ul class="nav navbar-nav center-navbar" style="font-size: x-large;">
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-expanded="false">Portfolio<span class="caret"></span></a>
    ...
    <div class="wrapper">
          <div class="jcarousel-wrapper" style="width: 1200px; height: 500px;" >
              <div class="jcarousel" >
                  <ul>
                    <?php
                      $directory = "bootstrap/assets/transformations/";
                      // echo $directory;
                      foreach(glob($directory . '*') as $filename) {
                          echo '<li><img src="'.$filename.'" width="480" height="480" alt=""></li>';
                      }
                    ?>
                  </ul>
              </div>
